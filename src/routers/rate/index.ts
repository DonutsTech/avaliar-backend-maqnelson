...
class RateRouter {
  public static create(router: Router): void {
    ...
    router.post("/app/rate", isAuthenticate, validatorRole(['USER']), schemaValidator("rate/create"), rateController.createRateForm);
    router.get("/app/rate", isAuthenticate, validatorRole(['USER']), rateController.filterRateForminEmailVend);
  }
}
